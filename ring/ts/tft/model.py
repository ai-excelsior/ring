...
class TemporalFusionTransformer(AutoRegressiveBaseModelWithCovariates):
    def __init__(
        ...
        * non-linear variable processing in variable selection network can be shared among decoder and encoder
        ...
        static_input_sizes = {
            name: self.hparams.embedding_sizes[name][1] for name in self.hparams.static_categoricals
        }
    ...
    #                 attention[
    #                     i,
    #                     : attention.size(1) - out["encoder_lengths"][i] - attention_prediction_horizon,
    #                 ] = 0.0
