...
def train(data_config: DataConfig, data_train: pd.DataFrame, data_val: pd.DataFrame, **kwargs):
    ...
    predictor = None if load_state is None else Predictor.load(load_state, RNNSeq2Seq)
    ...
    validate(kwargs.get("save_state", None), data_val, begin_point=None)
...
if __name__ == "__main__":
    ...
    train_parser.add_argument("--n_heads", type=int, default=0, help="number of multi-attention")
